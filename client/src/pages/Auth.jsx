...
const Auth = ({isModel = false}) => {
  ...
  className={`w-full ${
    isModel
      ? "py-4"
      : "min-h-screen bg-[#f3f3f3] flex items-center justify-center px-8 py-20"
  }`}
>
      <motion.div
...
>
        ...
        text-center leading-snug mb-4'>
            Continue with
            <span className='bg-green-300 text-green-600
        ...
        leading-relaxed mb-8'>
            ...
            track your progress, and unlock detailed performance 
            insights.
        </p>
         ...
         justify-center gap-3 py-3 bg-black text-white
