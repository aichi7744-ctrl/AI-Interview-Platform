...
// FIXED: correct recharts imports
import {
  ResponsiveContainer,
  AreaChart,
  Area,
...
const Step3Report = ({ report }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="md:mb-10 w-full flex items-start
          gap-4 flex-wrap"
        >
          <button
        ...
        <button
          ...
          hover:bg-emerald-700 text-white px-6
      ...
      >
        <div className="space-y-6">
          <motion.div
            ...
            shadow-lg p-6 sm:p-8 text-center"
          >
            <h3
        ...
        <div className="lg:col-span-2 space-y-6">
          <motion.div
            ...
            sm:rounded-3xl shadow-lg p-5 sm:p-8"
          >
            <h3
              className="text-base sm:text-lg 
              font-semibold text-gray-700 mb-4 sm:mb-6"
            >
              Performance Trend
            </h3>
